...
display(f'Hungry? here is a exclusive offer for exactly those who clicked the About Us page! Claim your {product_names[0]} for only {popular_item_price} PHP instead of {menu_prices[3]}!', target='infotext2')